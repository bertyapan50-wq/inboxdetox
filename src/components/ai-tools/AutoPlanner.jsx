...
const AutoPlanner = () => {
  ...
  const handleGeneratePlan = async () => {
    try {
      ...
      if (response.success) {
        alert(`✅ Plan generated! Scheduled ${response.schedule.length} tasks`);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            AI-powered daily scheduling • Let AI organize your day automatically
          </p>
        </div>
        ...
        {pendingTasks.length === 0 && scheduledTasks.length === 0 && tasks.length === 0 && (
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-1">Get Started with Auto Planner</h3>
              <p className="text-blue-700 text-sm">
                Create some tasks, then click "Generate Daily Plan" to let AI automatically schedule your day. 
                The AI will consider your work hours, task priorities, and deadlines to create an optimal schedule.
              </p>
            </div>
          </div>
        )}
